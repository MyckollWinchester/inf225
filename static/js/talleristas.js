...
async function getTalleristas() {
  ...
  return [
    { id: 1, name: 'Talleristas 1' },
    { id: 2, name: 'Talleristas 2' },
    { id: 3, name: 'Talleristas 3' },
    { id: 4, name: 'Talleristas 4' },
    { id: 5, name: 'Talleristas 5' },
    { id: 6, name: 'Talleristas 6' },
    { id: 7, name: 'Talleristas 7' },
    { id: 8, name: 'Talleristas 8' },
    { id: 9, name: 'Talleristas 9' },
    { id: 10, name: 'Talleristas 10' },
  ]
}
...
searchForm.addEventListener('submit', async e => {
  ...
  await getTalleristas().then(talleristas => {
